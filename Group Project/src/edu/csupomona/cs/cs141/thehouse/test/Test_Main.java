...
public class Test_Main {
	...
	public static void printGrid_Test2() {
		...
		System.out
				.println("B is the briefcase, R is the room, P is the player");
		Grid grid = new Grid();
		// grid.setBriefcase();
		grid.printGrid();
		System.out
	...
	public static void printGrid_Test3() {
		...
		System.out
				.println("B is the briefcase, R is the room, P is the player, E is the Enemy");
		Grid grid = new Grid();
		// grid.setBriefcase();
		// grid.setEnemy();
		grid.printGrid();
	...
	public static void printGrid_Test5() {
		...
		System.out
				.println("B is the briefcase, R is the room, P is the player, E is the Enemy");
		System.out
				.println("Spawn PowerUps, Enemies, and the Briefcase room in an infinte loop");
		while (true) {
			Grid grid = new Grid();
			// grid.setBriefcase();
			// grid.setEnemy();
	...
	public static void printGrid_Test7() {
		...
		System.out
				.println("B is the briefcase, R is the room, P is the player, E is the Enemy");
		System.out
				.println("Checks if the object is free then prints out the object at each location");
		Grid grid = new Grid();
		Player ply = new Player();
		// grid.setBriefcase();
		// grid.setEnemy();
	...
	public static void playerMove_Test4() {
		...
		System.out
				.println("Standard Player Movement w/ Other Object Spawn and Object Testing");
		System.out
				.println("|-----------------------------------------------------------");
		Player ply = new Player();
		Grid grid = new Grid();
