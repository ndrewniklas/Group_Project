...
public class UserInterface {
	...
	/**
	 * This field holds the choice of the user. There are 7 potential values for
	 * the user to select: left, right, up, down, shoot, save, exit
	 */
	...
	public void rules() {
		...
		System.out.println();
		System.out
				.println("The Galactic Empire has spread its forces too thin in its war against the Alliance to Restore the Republic."
		...
		System.out.println();
		System.out
				.println("You are one of these so-called smugglers; however, nothing could prepare you for the brilliant ambush by Pirate Captain Rodriguez. "
		...
		System.out.println();
		System.out
				.println("Forget honor, bravery, or ferocity – you just want to disarm the bomb so you can get off of the ship alive! "
		...
		System.out
				.println("You will be spawned in the bottom left-hand corner of your ship. "
		...
		System.out
				.println("You have several options available to you while the game is running.");
		...
		System.out
				.println("5. Look - you can use this at the start of every round, it lets you see two"
						+ " blocks in any direction.");
		System.out
				.println("6. Shoot - you can use this if you have a bullet left. It will kill one enemy"
						+ " if in the path of the bullet.");
		System.out
				.println("7. Save - use this to save the game, and return to it later by selecting"
						+ " 'continue' in the main menu.");
		System.out
				.println("8. Exit - use this to quit the game, be aware that progress will not be saved.");
		System.out.println();
		System.out.println("Type \"return\" or 0 to return to the main menu:");
	}

	/**
	 * This method will print the main menu of the game to the user and give
	 * options such as, "continue" or "new game".
	 */
	public void mainMenu() {
		System.out.println("Welcome to: ");
		System.out.println();
		System.out
				.println("     _______..______      ___       ______  _______    .______    __  .______          ___   .___________. _______     _______.");
		System.out
				.println("    /       ||   _  \\    /   \\     /      ||   ____|   |   _  \\  |  | |   _  \\        /   \\  |           ||   ____|   /       |");
		System.out
				.println("   |   (----`|  |_)  |  /  ^  \\   |  ,----'|  |__      |  |_)  | |  | |  |_)  |      /  ^  \\ `---|  |----`|  |__     |   (----`");
		System.out
				.println("    \\   \\    |   ___/  /  /_\\  \\  |  |     |   __|     |   ___/  |  | |      /      /  /_\\  \\    |  |     |   __|     \\   \\    ");
		System.out
				.println(".----)   |   |  |     /  _____  \\ |  `----.|  |____    |  |      |  | |  |\\  \\----./  _____  \\   |  |     |  |____.----)   |   ");
		System.out
				.println("|_______/    | _|    /__/     \\__\\ \\______||_______|   | _|      |__| | _| `._____/__/     \\__\\  |__|     |_______|_______/    ");
		System.out.println();
	...
	/**
	 * This method simply prints out all potential options for the User to
	 * choose from during the game's runtime. "Debug Mode" will show all objects
	 * on the grid and give the user infinite ammo; "Save" will save the game's
	 * state. "New Game" will reset the game's state. "Mute the music" will end
	 * the sound byte for the background music, if the music is already off it
	 * will start again.
	 */
	public void options() {
	...
	/**
	 * This method simply prints out all possible actions the User can make
	 * during runtime. Primarily, the actions that will affect the game state
	 * are "Look", "Move", and "Shoot". Selecting options will call
	 * {@link #options()}. Selecting exit will end the program.
	 */
	...
	/**
	 * This method simply prints out all possible actions the User can make
	 * during runtime; specifically after they select the "Look" function.
	 * Primarily, the actions that will affect the game state are "Move" and
	 * "Shoot". Selecting options will call {@link #options()}. Selecting exit
	...
	/**
	 * This method will set the userChoice to whatever {@code String} is passed
	 * to it.
	 * 
	 * @param choice
	 *            - {@code String} containing some value intended for
	 *            {@link #userChoice}.
	 */
	...
	/**
	 * This method simply prints out the four cardinal directions that the user
	 * can move.
	 */
	...
	/**
	 * This method will pass an input - saved as a {@code String} to whatever
	 * calls it, after collecting it from the user.
	 */
	...
	/**
	 * This method prints whenever the {@link Player} collects the {@link Radar
	 * bomb detector}
	 */
	public void radarActivated() {
		System.out.println("You've picked up the detector!");
		System.out
				.println("You can now see which reactor the bomb is planted in!");
	}

	/**
	 * This prints whenever the {@link Player} picks up {@link ExtraAmmo} and
	...
	/**
	 * This method prints whenever the {@link Player} picks up the
	 * {@link Shield}.
	 */
	...
	/**
	 * This method will print whenever the {@link Player} shoots and kills an
	 * {@link Enemy}.
	 */
	...
	/**
	 * This method simply prints out the four cardinal directions that the
	 * {@link Player} can shoot.
	 */
	...
	/**
	 * This method exists to force the user to hit {@code Enter} before the next
	 * line is called.
	 */
	public void pause() {
		sc.nextLine();
	...
	/**
	 * This method exists to determine whether or not a new game will be
	 * created.
	 * 
	 * @return {@code Boolean} answer - true if the user selects yes, false if
	 *         the user selects no
	 */
	...
	/**
	 * This method prints when the {@link Player} is murdered by an
	 * {@link Enemy}
	 */
	...
	/**
	 * This method prints out information pertinent to the game state. Such as:
	 * how much ammo the player has and whether they have a shield activated.
	 * 
	 * @param ply
	 *            - {@link Player} object
	 * @param hasRadar
	 *            - {@code boolean} true when {@link Player} has radar, false
	 *            otherwise.
	 * @param m
	 *            - {@code int} containing the amount of turns left for
	 *            {@link Shield}.
	 * 
	 */
	...
	public void congrats() {
		System.out
				.println("Congratulations you disarmed the bomb and made it out alive!");
	}
