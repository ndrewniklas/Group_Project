...
/**
 * This class deals with all interactions between the game and saving/loading functions.
 * Primarily the only objects that are saved are the {@link Grid} and {@link Player}, this
 * is also true for the objects that are loaded.
 * 
...
public class File_Handler {
	...
	/**
	 * This field represents a {@link Grid} object in its state 
	 * from the time that "save" is selected by the user in the 
	 * {@link GameEngine#setOption} method.
	 */
	private Grid savedGrid;
	
	/**
	 * This field represents the name of the save file for 
	 * the {@link GameObject}s
	 */
	private final String SAVE_FILE = "save.obj";
	
	/**
	 * This field represents the name of the file for the 
	 * {@link Grid} object
	 */
	...
	/**
	 * This method is called when either the user saves or loads a 
	 * game. It does this by collecting a {@code String} with the 
	 * value of "save" or "load". 
	 * "Save" saves the {@link Grid} and {@link Player} objects by
	 * 		passing them to {@link #saveFile(Grid, Player)}.
	 * "Load" loads the {@link Grid} by calling {@link #openFile(Grid)}.
	 * 
	 * @param choice
	 * 	{@code String} with value of "save" or "load" 
	 * @param grid
	 * 	{@link Grid} {@link #savedGrid} that will be saved or overwritten
	 * @param player
	 * 	{@link Player} in its state from the point that the game is saved
	 */
...
//				e.printStackTrace();
	 ...
	 * {@link Grid#overwriteGOG(GameObject[][]) where the {@code GameObject[][]}
	...
	/**
	 * This method returns the {@link Grid} object to be used when the game is continued.
	 * It does this by reading the {@link Grid} with {@link #ois} and saving it to
	 * {@link #savedGrid}.
	 * @return
	 ...
	 * three separate files named "save.obj", "save.grid", and "save.plr" respectively.
	 * It uses {@link #oos} to perform these functions.
	 * @throws IOException 
	 * 
	 */
